...
$Companies = $encoder->Get_All_Companies_With_Specialization(GeneralCategory::EDUCATIONAL);
		...
		<div class="col-sm-12 margin_top_10">
			<div class="panel panel-default margin_top_10">
				<div class="panel-body text-center">
					<h4> ሁሉም የትምህርት ተቋማት የድርጅት ዝርዝር </h4>
				</div>
			</div>
								...
								<td>
									<p>
										...
										if($Belong_to == Belong::COMPANY_WITH_BUILDING ){
											...
											?>
											<a class="btn btn-warning btn-xs" href="Edit_Educational_Institute.php?CB=1&company_id=<?php echo($Company_ID);?>">Edit</a>
											<a class="btn btn-danger btn-xs" href="Delete_Educatioanl_Institute.php?Delete=1&company_id=<?php echo($Company_ID);?>&on_building=1">Delete</a>
										...
										<?php
											...
											?>
											<a class="btn btn-warning btn-xs" href="Edit_Educational_Institute.php?CA=1&company_id=<?php echo($Company_ID);?>">Edit</a>
											<a class="btn btn-danger btn-xs" href="Delete_Educatioanl_Institute.php?Delete=1&company_id=<?php echo($Company_ID);?>">Delete</a>
