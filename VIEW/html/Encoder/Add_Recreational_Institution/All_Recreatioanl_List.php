								...
								<td>
									<p>
										...
										if($Belong_to == Belong::COMPANY_WITH_BUILDING ){
											...
											?>
<a class="btn btn-warning btn-xs" href="Edit_Recreational_Institute.php?CB=1&company_id=<?php echo($Company_ID);?>">Edit</a>
<a class="btn btn-danger btn-xs" href="Delete_Recreational_Institute.php?Delete=1&company_id=<?php echo($Company_ID);?>&on_building=1">Delete</a>
										...
										<?php
											...
											?>
<a class="btn btn-warning btn-xs" href="Edit_Recreational_Institute.php?CA=1&company_id=<?php echo($Company_ID);?>">Edit</a>
<a class="btn btn-danger btn-xs" href="Delete_Recreational_Institute.php?Delete=1&company_id=<?php echo($Company_ID);?>">Delete</a>
