...
$categories = $encoder->GetGeneralCategory(GeneralCategory::RECREATIONAL);//get category that are in a generic Education category
...
if($_SERVER['REQUEST_METHOD']== 'GET'){
	...
	$specialization = $encoder->GetSpecialization(GeneralCategory::RECREATIONAL);
...
<div class="panel panel-default">
	<div class="panel-body text-center">
		...
		<h4>Edit Recreatioanl Institute (የመዝናኛ ተቋማት ማስተካከያ)</h4>
