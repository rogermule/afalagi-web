...
$categories = $encoder->GetGeneralCategory(GeneralCategory::RECREATIONAL);
$company_ownership = $encoder->Get_Ownerships();//get different type of ownership
$specialization = $encoder->GetSpecialization(GeneralCategory::RECREATIONAL);//get specialization
...
<div class="panel panel-default">
	<div class="panel-body text-center">
		...
		<h4>Add Recreational Institutions (የመዝናኛ ተቋማት መጨመርያ)</h4>
